...
public class Layer2 {
	...
	private void II_step_one(final MPGLib.mpstr_tag mp, final int[] bit_alloc,
	...
	private void II_step_two(final MPGLib.mpstr_tag mp, final int[] bit_alloc,
	...
	public <T> int do_layer2(final MPGLib.mpstr_tag mp, final float[] pcm_sample,
