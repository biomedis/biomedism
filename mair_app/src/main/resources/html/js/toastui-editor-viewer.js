...
(function webpackUniversalModuleDefinition(root, factory) {
  ...
  /******/ ([
    ...
    /***/ (function(module, __webpack_exports__, __webpack_require__) {
       ...
       * @param {HTMLElement} node - the target node
       * @param {string} directionВ -В theВ directionВ toВ findВ nodeВ ('previous',В 'next')
       * @returns {function} - the condition to find the node
       * @ignore
       */
       ...
       * @param {Node} containedNode -В node to find
       ...
       * @param {string|Node} found -В selector or element to find node
